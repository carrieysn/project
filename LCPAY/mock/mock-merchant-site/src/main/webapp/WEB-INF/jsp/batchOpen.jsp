...
<body onload="initURL()">
    ...
    <div class="container">
		...
		<form action="<c:url value="/lc/batchOpen.lc" />" method="post" target="_blank" >
			<ul>
	            <li>
					<label>商户号：</label>
