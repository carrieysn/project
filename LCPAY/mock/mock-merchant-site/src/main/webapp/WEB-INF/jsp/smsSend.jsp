...
<body onload="">
    ...
    <!--内容-->
    <div class="container">
        <p class="raya-firstpay">发送短信接口测试页面(<span class="requireicon">*</span>标记为必填参数)</p>
        <div class="raya-ordertable">
		<form action="<c:url value="/lc/smssend.lc" />" method="post" target="_blank" onsubmit="return validate()">
			<ul>
	            <li>
					<label>发送短信类型：</label>
			...
			<input class="raya-submit" value="发送短信" type="submit">
		</form>
		</div>
