...
public class OpenCardCallBackCifValidate implements IParamValidate {
//	private static final Logger LOGGER = LoggerFactory.getLogger(GeneralTradeService.class);
	...
	/*	LOGGER.info("OpenCardCallBackCifValidate-开始校验业务参数：" + tradeParam.toString());
		// TODO
		LOGGER.info("OpenCardCallBackCifValidate-业务参数校验通过！");*/
	}
}
