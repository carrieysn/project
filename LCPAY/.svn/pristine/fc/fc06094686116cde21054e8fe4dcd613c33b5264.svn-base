 ...
 */
public class UnionpayQueryOutputBean implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = -4663046803420398552L;
	private Long lcId;
    private String mid;
    ...
    public UnionpayQueryOutputBean() {
    }
