...
<head>
    <% 
		pageContext.setAttribute("title", "银信证交易测试-申请解付接口");
	%>
...
<!--内容-->
<div class="container">
    <p class="raya-firstpay">申请解付接口页面(<span class="requireicon">*</span>标记为必填参数)</p>
    <div class="raya-ordertable">
        <form action="<c:url value="/lc/apply.lc" />" method="post" target="_blank" onsubmit="return validate()">
            <ul>
                <li>
                    <label>银信证ID：</label>
                ...
                <li>
                    <label>验证码：</label>
                    <input class="raya-input" id="signCode" name="signCode" value="" maxlength="16"/>
                </li>
                <li>
                    <label>履约流水号：</label>
                    <input class="raya-input" id="appointmentId" type="text" name="appointmentId" value="" maxlength="20" required/> <span class="requireicon">*</span>
                </li>
                <li>
                    <label>备注：</label>
            ...
            <input class="raya-submit" value="申请解付提交" type="submit">
        </form>
    </div>
