...
public class LcGatewayConfig implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
		...
		//lcInterfaceUrls.put("cache.lc", lcGatewayBaseURL + "/cache/removeCache");
		lcInterfaceUrls.put("cache.lc", lcGatewayBaseURL + "/cache/selectCache");
    ...
    public static String getMysqlConnectString() {
