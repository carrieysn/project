 ...
 */
public class AlipayTransferInputBean extends AbstractInputBean {
    private static final long serialVersionUID = 7221559047992306332L;
    ...
    private AccountPropertyType payerType;
    ...
    public AlipayTransferInputBean(LoggerEnum.Scene scene) {
        super(scene);
    }
    ...
    public AccountPropertyType getPayerType() {
        return payerType;
    }

    public void setPayerType(AccountPropertyType payerType) {
