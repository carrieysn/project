...
public class InvalidateLcServiceImpl extends AbstractLcProductServiceImplBase<InvalidateLcInputBean, InvalidateLcOutputBean> implements InvalidateLcService {
