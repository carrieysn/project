...
@Component
public class ApplyLcMessageServiceListener extends BaseMessageListener<LcApplyParamBean> {

    @Autowired
    private AutoApplyLcMessageService autoApplyLcMessageService;
    ...
    @Override
    public MessageService<LcApplyParamBean> getMessageService() {
