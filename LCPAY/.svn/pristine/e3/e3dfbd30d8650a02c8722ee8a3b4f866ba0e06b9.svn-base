...
public abstract class CoreBusinessServiceImplBase<I extends Serializable, O extends Serializable> implements BusinessService {
...
//    @Override
    ...
    private BusinessOutput<O> handleExecuteException(Throwable e) {
        ...
        if (e instanceof CoreValidationRejectException) {
            ...
            AbstractCoreException vrEx = (AbstractCoreException) e;
