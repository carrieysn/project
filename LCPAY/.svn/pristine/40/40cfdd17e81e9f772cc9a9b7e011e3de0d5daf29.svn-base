...
<body onload="initURL()">
    ...
    <!--内容-->
    <div class="container">
        <p class="raya-firstpay">星意线下充值接口测试页面(<span class="requireicon">*</span>标记为必填参数)</p>
        <div class="raya-ordertable">
		<form action="xy/offline" method="post" target="_blank" onsubmit="return validate()">
			<ul>
				<li>
					<label>订单号：</label>
				...
				<li>
					<label>金额：</label>
					<input class="raya-input" id="amount" name="amount" value="51234" maxlength="50"/><span class="requireicon">*</span>（角）
				</li>
			</ul>
			<input class="raya-submit" value="线下充值" type="submit">
		</form>
		</div>
