...
public class InitLcInputBean extends AbstractInputBean {
    ...
    public String toString() {
        return "InitLcInputBean{" +
                ...
                ", openValidSecond=" + openValidSecond +
                ", recvValidSecond=" + recvValidSecond +
                ", sendValidSecond=" + sendValidSecond +
                ", confirmValidSecond=" + confirmValidSecond +
                ", payValidSecond=" + payValidSecond +
