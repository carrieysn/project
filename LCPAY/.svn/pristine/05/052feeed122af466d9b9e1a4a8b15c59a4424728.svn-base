 ...
 */
@Component
@EnableGenerateRequestId(scene = LoggerEnum.Scene.QUEUE_TRANSFER)
public class LcAutoTransferTask extends BaseMessageTask {
    ...
    public void handleAutoTransferLc() {
        ...
        handleMessage(MessageEnum.MsgType.LC, MessageEnum.Scene.TRANSFERLC);
