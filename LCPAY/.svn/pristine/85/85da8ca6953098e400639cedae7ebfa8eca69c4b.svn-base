    ...
    public BusinessOutput<String> cifpayCallBack(GeneralTradeResult result) {
        ...
        if (org.springframework.util.StringUtils.hasText(queryTradeResult)) {
            ...
            if (TradeConfig.TRADE_RESULT_UNKNOWN_2.equalsIgnoreCase(queryTradeResult)) {
                logger.info("查询交易，交易结果为: queryTradeResult={}", queryTradeResult);
                tranStatus = LcTranStatus.FAIL;
            }
        }
        logger.info("银联回调信息返回交易结果为： {}", tranStatus);
        ...
        switch (reqReservedBean.getPayHandler()) {
            case FREEZE: {
                ...
                logger.info("准备发送 FREEZE 消息：lcId={}", lcOpen.getLcId());
                ...
                lcFreezeParamBean.setFreezeDesc(tradeDesc);
            ...
            case UNFREEZE: {
                ...
                logger.info("准备发送 UNFREEZE 消息：lcId={}", lcPay.getLcId());
                ...
                lcUnFreezeParamBean.setTransferDesc(tradeDesc);
            ...
            case Expiry: {
                ...
                logger.info("准备发送 Expiry 消息：lcId={}", lcInvalid.getLcId());
                ...
                lcExpiryParamBean.setExpiryDesc(tradeDesc);
            ...
            case Refund: {
                ...
                logger.info("准备发送 Refund 消息：lcId={}", lcRefund.getLcId());
                ...
                lcRefundParamBean.setRefundDesc(tradeDesc);
            ...
            default: {
                logger.error("未处理的银联回调请求: queryId={}", queryId);
            }
        }
