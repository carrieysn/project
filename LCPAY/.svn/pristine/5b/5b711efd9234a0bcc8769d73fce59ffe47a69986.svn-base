...
<head>
    <% 
		pageContext.setAttribute("title", "银信证交易测试-transfer接口");
	%>
...
<!--内容-->
<div class="container">
    <p class="raya-firstpay">解付接口测试页面(<span class="requireicon">*</span>标记为必填参数)</p>
    <div class="raya-ordertable">
        <form action="<c:url value="/lc/transfer.lc" />" method="post" target="_blank" onsubmit="return validate()">
            <ul>
                <li>
                    <label>银信证ID：</label>
                ...
                <li>
                    <label>申请解付ID：</label>
                    <input class="raya-input" type="text" id="applyId" name="applyId" value="" maxlength="20" required/> <span class="requireicon">*</span>
                </li>
                <li>
                    <label>备注：</label>
            ...
            <input class="raya-submit" value="解付" type="submit">
        </form>
    </div>
