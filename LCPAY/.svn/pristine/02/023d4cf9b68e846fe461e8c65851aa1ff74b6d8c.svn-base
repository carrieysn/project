...
public class UnionPayDingAuthFinishDeal implements IBankDeal {
	...
	public TrdUnionPayFlow insertUnionPayFlow(PayCifParam param) {
		...
		payFlow.setCurrencyCode(param.getCurrencyCode());
	...
	public Map<String, String> transToReqData4Level2(PayCifParam param) {
	...
	public Map<String, String> transToReqData4Level1(PayCifParam param) {
