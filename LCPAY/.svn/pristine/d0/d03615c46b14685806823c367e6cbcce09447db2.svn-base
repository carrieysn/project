 ...
 */
@Component
@EnableGenerateRequestId(scene = LoggerEnum.Scene.QUEUE_APPLY)
public class LcAutoApplyTask extends BaseMessageTask {
    ...
    public void handleAutoApplyLc() {
        ...
        handleMessage(MessageEnum.MsgType.LC, MessageEnum.Scene.APPLYLC);
