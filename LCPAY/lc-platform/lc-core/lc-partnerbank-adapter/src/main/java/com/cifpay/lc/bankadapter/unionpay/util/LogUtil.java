...
public class LogUtil {
	...
	private final static Logger GATELOG = LoggerFactory.getLogger("UNIONPAY_CIFPAY_LOG");
	private final static Logger GATELOG_ERROR = LoggerFactory.getLogger("UNIONPAY_CIFPAY_ERR_LOG");
	private final static Logger GATELOG_MESSAGE = LoggerFactory.getLogger("UNIONPAY_CIFPAY_MSG_LOG");

	final static String LOG_STRING_REQ_MSG_BEGIN = "============================== UNIONPAY_CIFPAY REQ MSG BEGIN ==============================";
	final static String LOG_STRING_REQ_MSG_END = "==============================  UNIONPAY_CIFPAY REQ MSG END  ==============================";
	final static String LOG_STRING_RSP_MSG_BEGIN = "============================== UNIONPAY_CIFPAY RSP MSG BEGIN ==============================";
	final static String LOG_STRING_RSP_MSG_END = "==============================  UNIONPAY_CIFPAY RSP MSG END  ==============================";
	...
	public static void printRequestLog(Map<String, String> reqParam) {
		...
		writeMessage(StringTool.printMap(reqParam));
