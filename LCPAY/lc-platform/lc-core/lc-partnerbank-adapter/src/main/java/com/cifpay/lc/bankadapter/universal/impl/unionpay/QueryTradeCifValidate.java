...
public class QueryTradeCifValidate implements IParamValidate {
/*	private static final Logger LOGGER = LoggerFactory
	...
	public void validate(AbsTradeParam tradeParam) {
		...
		/*LOGGER.info("QueryTradeCifValidate-开始校验业务参数：" + tradeParam.toString());
		// TODO
		LOGGER.info("QueryTradeCifValidate-业务参数校验通过！");*/
	}
}
