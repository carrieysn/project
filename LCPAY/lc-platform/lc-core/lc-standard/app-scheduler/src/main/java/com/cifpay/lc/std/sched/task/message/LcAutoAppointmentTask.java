 ...
 */
@Component
@EnableGenerateRequestId(scene = LoggerEnum.Scene.QUEUE_APPOINTMENT)
public class LcAutoAppointmentTask extends BaseMessageTask {
    ...
    public void handleAutoAppointmentLc() {
        ...
        handleMessage(MessageEnum.MsgType.LC, MessageEnum.Scene.APPOINTMENTLC);
