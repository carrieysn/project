...
public class Lc {
    ...
    private BigDecimal lcFreezingAmount;

    private BigDecimal lcBalance;

    private String lcPayChannel;
    ...
    public BigDecimal getLcFreezingAmount() {
        return lcFreezingAmount;
    }

    public void setLcFreezingAmount(BigDecimal lcFreezingAmount) {
        this.lcFreezingAmount = lcFreezingAmount;
    }
    ...
    public String getLcPayChannel() {
        return lcPayChannel;
    }

    public void setLcPayChannel(String lcPayChannel) {
        this.lcPayChannel = lcPayChannel == null ? null : lcPayChannel.trim();
    }
    ...
    public void setLcStatus(String lcStatus) {
        this.lcStatus = lcStatus == null ? null : lcStatus.trim();
    }
