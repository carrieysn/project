 ...
 *
 */
public class RefundCifParam extends AbsTradeParam {
	private static final long serialVersionUID = -6989853869167002394L;
	...
	private String origOryId;// 原始交易流水号(*)
	private String txnTime;// 订单发送时间(*)
	private Long txnAmt;// 交易金额(*)
	private String currencyCode;// 交易币种 (默认:RMB 156)

    public RefundCifParam() {
        super(LoggerEnum.Scene.UNION_REFUND);
    }
	...
	public String toString() {
		return "RefundCifParam [businessId=" + businessId + ", txnType=" + txnType + ", txnSubType=" + txnSubType
