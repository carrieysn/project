 ...
 *
 */
public class ExpiryCifParam extends AbsTradeParam {
	private static final long serialVersionUID = -155365337556866211L;
    ...
    public ExpiryCifParam() {
        super(LoggerEnum.Scene.UNION_EXPIRY);
    }
	...
	public String toString() {
		return "ExpiryCifParam [businessId=" + businessId + ", txnType=" + txnType + ", txnSubType=" + txnSubType
