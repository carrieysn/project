...
/**
 * Created by sweet on 16-9-20.
 */
public class PreLcDto implements Serializable {
    private static final long serialVersionUID = 889886707261646532L;
    ...
    public String toString() {
        ...
        builder.append(", lcNo=");
        builder.append(lcNo);
        builder.append(", lcType=");
        builder.append(lcType);
        builder.append(", lcCurrency=");
        builder.append(lcCurrency);
        builder.append(", lcAmount=");
        builder.append(lcAmount);
        builder.append(", payerId=");
        builder.append(payerId);
        builder.append(", payerAccno=");
        builder.append(payerAccno);
        builder.append(", payerType=");
        builder.append(payerType);
        builder.append(", payerBankCode=");
        builder.append(payerBankCode);
        builder.append(", payerBankName=");
        builder.append(payerBankName);
        builder.append(", payerMobile=");
        builder.append(payerMobile);
        builder.append(", recvId=");
        builder.append(recvId);
        builder.append(", recvAccno=");
        builder.append(recvAccno);
        builder.append(", recvType=");
        builder.append(recvType);
        builder.append(", recvBankCode=");
        builder.append(recvBankCode);
        builder.append(", recvBankName=");
        builder.append(recvBankName);
        builder.append(", recvMobile=");
        builder.append(recvMobile);
        builder.append(", openValidTime=");
        builder.append(openValidTime);
        builder.append(", recvValidTime=");
        builder.append(recvValidTime);
        builder.append(", sendValidTime=");
        builder.append(sendValidTime);
        builder.append(", confirmValidTime=");
        builder.append(confirmValidTime);
        builder.append(", payValidTime=");
        builder.append(payValidTime);
        builder.append(", lcStateReturnUrl=");
        builder.append(lcStateReturnUrl);
        builder.append(", lcStateNotifyUrl=");
        builder.append(lcStateNotifyUrl);
        builder.append(", lcOrderDetailUrl=");
        builder.append(lcOrderDetailUrl);
        builder.append(", thirdPartyCode=");
        builder.append(thirdPartyCode);
