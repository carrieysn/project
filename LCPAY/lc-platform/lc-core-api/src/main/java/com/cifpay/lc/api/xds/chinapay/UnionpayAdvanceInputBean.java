 ...
 */
public class UnionpayAdvanceInputBean extends AbstractInputBean {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7958456143076085756L;
	...
	public UnionpayAdvanceInputBean(LoggerEnum.Scene scene) {
		super(scene);
	}
