...
public class LcDto implements Serializable {
    private static final long serialVersionUID = 7414029915704194309L;
    ...
    public void setLcStateReturnUrl(String lcStateReturnUrl) {
        this.lcStateReturnUrl = lcStateReturnUrl;
    }
    ...
    public void setLcStateNotifyUrl(String lcStateNotifyUrl) {
        this.lcStateNotifyUrl = lcStateNotifyUrl;
    }
    ...
    public void setLcOrderDetailUrl(String lcOrderDetailUrl) {
        this.lcOrderDetailUrl = lcOrderDetailUrl;
    }
